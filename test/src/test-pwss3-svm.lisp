...
(define-test svm
  ...
  (assert-true (setf linear-svm (pwss3-svm::make-svm-learner training-vector (make-linear-kernel) 1)))
  ...
  (assert-true (setf rbf-svm (pwss3-svm:make-svm-learner training-vector rbf-kernel 100)))
  ...
  (assert-true (setf poly-svm (pwss3-svm::make-svm-learner training-vector (make-polynomial-kernel :gamma 1.0d0 :r 0.0d0 :d 2) 1)))
  ...
  (assert-true (setf svm (pwss3-svm:make-svm-learner training-vector rbf 10)))
