...
(define-test svm.smo.kernels
  ...
  (assert-true (setf rbf-kernel (clml.svm.smo::make-rbf-kernel :gamma 1.0d0)))
  (assert-true (> 0.00001d0 (- 8.315287191035679e-7 (clml.svm.smo::call-kernel-function-with-vectors rbf-kernel z-1 z-2))))
  (assert-true (setf poly-kernel (clml.svm.smo::make-polynomial-kernel :gamma 1.0d0 :r 0.0d0 :d 2)))
  (assert-true (= 2025.0d0 (clml.svm.smo::call-kernel-function-with-vectors poly-kernel z-1 z-2)))
  (assert-true (setf poly-kernel (clml.svm.smo::make-polynomial-kernel :gamma 1.0d0 :r 1.0d0 :d 2)))
  (assert-true (= 2116.0d0 (clml.svm.smo::call-kernel-function-with-vectors poly-kernel z-1 z-2)))
  (assert-true (setf poly-kernel (clml.svm.smo::make-polynomial-kernel :gamma 2.0d0 :r -89.0d0 :d 2)))
  (assert-true (= 1.0d0 (clml.svm.smo::call-kernel-function-with-vectors poly-kernel z-1 z-2)))
  (assert-true (setf poly-kernel (clml.svm.smo::make-polynomial-kernel :gamma 3.0d0 :r -133.0d0 :d 3)))
...
(define-test smo.svm
  ...
  (assert-true (setf linear-svm (clml.svm.smo::make-svm-learner training-vector #'clml.svm.smo::linear-kernel 1)))
  ...
  (assert-true (setf rbf-kernel (clml.svm.smo::make-rbf-kernel :gamma 0.05)))
  (assert-true (setf rbf-svm (clml.svm.smo::make-svm-learner training-vector rbf-kernel 100)))
  ...
  (assert-true (setf poly-svm (clml.svm.smo::make-svm-learner training-vector (clml.svm.smo::make-polynomial-kernel :gamma 1.0d0 :r 0.0d0 :d 2) 1)))
